...
object Strings {
    ...
    const val DEVICE_PAGE_EDIT_MAX_SIZE_TITLE = "Size Limit"
    const val DEVICE_PAGE_EDIT_MAX_SIZE_DETAILS = "Set video width or height limit."
    const val DEVICE_PAGE_EDIT_MAX_FRAME_RATE_TITLE = "FPS Limit"
