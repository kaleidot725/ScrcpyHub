...
class ScrcpyCommandFactoryTest : StringSpec(
    {
        "create" {
            ...
            val device1 = Device(id = "DEVICE1", name = "NAME", customName = "CUSTOM_NAME", maxSize = null)
            factory.create(device1) shouldBe listOf("test/scrcpy", "-s", "DEVICE1")

            val device2 = Device(id = "DEVICE2", name = "NAME", customName = "CUSTOM_NAME", maxSize = 1000)
